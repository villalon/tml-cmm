 ...
 * @param <V>
 */
public class TerminologicalRelationship<V> extends Relationship<V> {
	 ...
	 * @throws Exception
	 */
	public TerminologicalRelationship(V sourceConcept, String linkingWord, V targetConcept) throws Exception {
		super(sourceConcept, linkingWord, targetConcept);
	...
	public boolean equals(Object obj) {
		if(obj instanceof TerminologicalRelationship) {
			TerminologicalRelationship relationship = (TerminologicalRelationship) obj;
